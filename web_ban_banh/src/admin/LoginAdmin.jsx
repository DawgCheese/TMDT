...
const LoginAdmin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setTimeout(() => navigate("/pageadmin"), 1500);
        } catch (error) {
            ...
            <div className="min-h-screen flex flex-col md:flex-row">
                ...
                <div className="md:w-1/2 w-full bg-[#f5f2e8] flex flex-col items-center justify-center px-6 py-6 relative">
                    <div className="max-w-sm w-full">
                        ...
                        <h2 className="text-2xl font-bold text-center mb-2">Đăng Nhập ADMIN</h2>
                ...
                {/* Right (Image) */}
                <div className="md:w-1/2 h-181 w-full hidden md:block">
                    <img
